...
function OrionWorking({ active, mode = 'generate', onCancel, compact = false }) {
  ...
  return (
    <section className={`orion-working ${compact ? 'compact' : ''}`} role="status" aria-live="polite">
      ...
      <div className="orion-working-copy">
        ...
        <h3>{TITLES[mode] || TITLES.generate}</h3>
        ...
        <div className="orion-working-footer">
          <span>O resultado aparecerá automaticamente quando o processamento terminar.</span>
